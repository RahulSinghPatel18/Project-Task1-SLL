...
const Dashboard = () => {
  const { user, setuser, company, setcompany, year, setyear } = useAppContext();

 

  return (
    <div className="min-h-screen px-4 bg-gradient-to-br from-slate-50 to-blue-50">
      {/* Clean White Card Layout */}
      <div className="mx-auto max-w-8xl">
        <div className="p-2 border border-gray-100 shadow-2xl bg-white/80 backdrop-blur-sm rounded-3xl md:p-12">
          ...
          <div className="grid gap-8 mb-16 lg:grid-cols-2">
            ...
            <div className="p-8 transition-all duration-300 border border-green-100 group bg-gradient-to-br from-pink-50 to-pink-50 rounded-2xl hover:shadow-xl hover:-translate-y-2">
              <div className="flex items-center mb-6 space-x-4">
                <div className="flex items-center justify-center w-20 h-20 shadow-lg bg-gradient-to-r from-pink-500 to-pink-500 rounded-2xl">
                  <HiCalendar className="w-10 h-10 text-white" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-gray-800">Year</h3>
                  <p className="text-gray-500">Year Details</p>
                </div>
              </div>
              <h2 className="text-xl font-bold text-gray-800 break-all">
